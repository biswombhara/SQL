...
SELECT SUBSTRING('dinesh',2,10) -- Returns the part of text from starting position to the number of characters specified
...
------ Object Explorer -> Select Database -> Right Click -> Tasks -> import flat file -> browse 
